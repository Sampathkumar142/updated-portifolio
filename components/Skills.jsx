...
function Skills() {
  ...
  return (
    <div className="ph:p-2 sm:pl-12">
      <h2 className="ph:text-2xl text-lg underline underline-offset-4 decoration-orange-600 decoration-solid decoration-2 font-bold">
        {" "}
        Skills
      </h2>
      <div className="flex flex-col ">
        {skillsData.map((category, index) => (
          <div key={index} className="m-2">
            <h1 className="ph:text-base text-xs text-[#19A7CE] font-semibold underline underline-offset-8 decoration-2  decoration-slate-100 my-4">
              {category.title}
            </h1>
