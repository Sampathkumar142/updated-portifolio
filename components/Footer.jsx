      ...
      <section className="ph:grid ph:grid-cols-2 ph:gap-4 w-full ph:h-[50vh] h-[20vh] my-10  ">
        ...
        <div className="flex ph:items-center ph:justify-center items-start ph:m-10 m-4 ">
          <div className="items-center">
            <h3 className="mb-4 ph:text-sm text-[10px]">
              {" "}
              <BiCurrentLocation className="inline   ph:mr-4  h-[30px] w-[30px] mr-2" />{" "}
              DNo:1-42, munsif Street, Rayavarm, EastGodavari, Ap, India-53346
            </h3>
            <h3 className="mb-4 ph:text-sm text-[10px]">
              {" "}
              <BiPhone className="inline  ph:mr-4  h-[30px] w-[30px] mr-2" />
              <a href="tel:+917995736123">+91 7995736123</a>
            </h3>
            <h3 className="ph:text-sm text-[10px]">
              {" "}
              <BiLogoGmail className="inline   ph:mr-4  h-[30px] w-[30px] mr-2 p-1" />
              <a href="mailto:praveensampathkumar.parvathini@gmail.com">
